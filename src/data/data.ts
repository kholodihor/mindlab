...
export const coursesList: Array<CoursesList> = [
  ...
  },
  {
    ...
    components: {mob: [], tab: ['#Зустріч із стартаперами'], desk: ['#Зустріч із стартаперами', '#Зустріч з бізнесом']} ,
    color: '#ffecd0',
    classname: 'roseLight',
    href: '/courses/career'
  },
  {
    ...
    components: {mob: ['#Запуск Start up'], tab: ['#Запуск Start up'], desk: ['#Запуск Start up', '#Скіли ХХІ ст.']} ,
    color: '#8d83ff',
    classname: 'violet',
  ...
  },
  {
    ...
    components: {mob: [], tab: ['#UI/UX Design'], desk: ['#UI/UX Design', '#FE/BE', '#Digital Marketing']},
    color: '#03aa89',
    classname: 'green',
  ...
  },
  {
    ...
    components: {mob: [], tab: ["#Комп'ютерне мистецтво"], desk: ["#Комп'ютерне мистецтво", '#Відео-мистецтво']} ,
    color: '#2928e3',
    classname: 'blue',
    href: '/courses/art'
  },
  {
    ...
    components: {mob: [], tab: ['#Теорія соціальних змін'], desk: ['#Теорія соціальних змін', '#Соціологія нації']},
    color: '#fed1ce',
    classname: 'rose',
