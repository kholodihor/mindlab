...
const EditTestimonials = ({ id }: { id: string })=> {
   ...
   Swal.fire({
    ...
    return (
        <div>
    <PageTitle title='Редагування відгуку' isAddButtonDisplayed={false} isSettingsButtonDisplayed={false}/>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className={css.btt__form}>
            ...
            <SubmitButton text='Редагувати відгук'  disabled={!isDirty || !isValid} />
          </div>
        </form>
